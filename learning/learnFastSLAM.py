...
# Akira Taniguchi 2017/01/18-2017/02/02-2017/02/13-
##############################################
...
if __name__ == '__main__':
    ...
    for i in xrange(R): ###############
      ...
      W_list[i], ST = [],[[] for s in xrange(step)] #ReadWordData(step, filename, i)
      print "Read word data."
      CT, IT = ReaditCtData(trialname, step, i)
      print "Read Ct,it data."
      print "CT",CT
      print "IT",IT
      ct, it, p_weight_log[i] = 1,1,0 #Learning(step, filename, i, Xp[i], ST, W_list[i], CT, IT, FT)          ##場所概念の学習
